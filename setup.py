...
mycursor.execute("ALTER TABLE patient_doctor ADD CONSTRAINT patient_doctor_ibfk_1 FOREIGN KEY (PSSN) REFERENCES patient (SSN) ON DELETE CASCADE, ADD CONSTRAINT patient_doctor_ibfk_2 FOREIGN KEY (DSSN) REFERENCES doctor (SSN) ON DELETE CASCADE;")
mycursor.execute("ALTER TABLE patient_files ADD CONSTRAINT patient_files_ibfk_1 FOREIGN KEY (PSSN) REFERENCES patient (SSN) ON DELETE CASCADE,ADD CONSTRAINT patient_files_ibfk_2 FOREIGN KEY (DSSN) REFERENCES doctor (SSN) ON DELETE CASCADE;")
